<?php 
		...
		if(isset($_POST['create'])){
			...
			$photo=$imgclassget->upload_fiximage("upload","photo","photo_upload_".$table_name."_".time());  
                        ...
                        $insert=array('name'=>$name,'photo'=>$photo,'date'=>date('Y-m-d'),'status'=>1);
			...
			{$updatearray=array("id"=>$id);if(!empty($_FILES['photo']['name']))
					{
						...
						$photo=$ex_photo;
					}$upd2=array('name'=>$name,'photo'=>$photo,'date'=>date('Y-m-d'),'status'=>1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
        	<h1 class="content-heading bg-white border-bottom">Brand Name</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Brand Name</a></li>
                    <li><a href="brand_name_data.php">Brand Name List</a></li>
                </ul>
            </div>
                ...
                <!-- Widget -->
                        ...
                        <div class="widget widget-inverse" >
                            ...
                            <div class="widget-head">
                                <h4 class="heading">Update/Change - Brand Name</h4>
                            </div>
                            <!-- // Widget heading END -->
                            ...
                            <!-- Widget heading -->
                            <div class="widget-head">
                                <h4 class="heading">Create New Brand Name</h4>
                            </div>
                            <!-- // Widget heading END -->
