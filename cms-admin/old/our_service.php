...
if (isset($_POST['create'])) {
    ...
    if (!empty($details) && !empty($priority)) {
        $insert = array('details' => $details, 'priority' => $priority, 'date' => date('Y-m-d'), 'status' => 1);
    ...
    if (!empty($details) && !empty($priority)) {
        ...
        $upd2 = array('details' => $details, 'priority' => $priority, 'date' => date('Y-m-d'), 'status' => 1);
...
<!--[if !IE]><!--><html><!-- <![endif]-->
    ...
    <body class="">
        ...
        <div id="content">
            <h1 class="content-heading bg-white border-bottom">Our Service</h1>
            <div class="innerAll bg-white border-bottom">
                <ul class="menubar">
                    <li class="active"><a href="#">Create New Our Service</a></li>
                    <li><a href="our_service_data.php">Our Service List</a></li>
                </ul>
            </div>
                ...
                <div class="widget widget-inverse" >
                    ...
                    if (isset($_GET['edit'])) {
                        ...
                        <div class="widget-head">
                            <h4 class="heading">Update/Change - Our Service</h4>
                        </div>
                        <!-- // Widget heading END -->
                        ...
                        <div class="widget-body"><form  class="form-horizontal" method="post" action="" role="form">
                                <input type="hidden" name="id" value="<?php echo $_GET['edit']; ?>"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <textarea id='editor' name='details' placeholder='Details' class='form-control'><?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "details"); ?></textarea><script>
...
<?php } else { ?>
                        <!-- Widget heading -->
                        <div class="widget-head">
                            <h4 class="heading">Create New Our Service</h4>
                        </div>
                        <!-- // Widget heading END -->
