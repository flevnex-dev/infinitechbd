        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#product_30").kendoGrid({
                ...
                columns: [{field: "name", title: "Name",width: "200px"},
                    {field: "brand_id", title: "Brand ID",width: "200px"},
                    {field: "product_category_id", title: "Product Category ID",width: "200px"},
                    {field: "photo_thumble", title: "Photo thumble",width: "120px"},
                    {field: "photo_1", title: "photo 1",width: "90px"},
                    {field: "photo_2", title: "photo 2",width: "90px"},
                    {field: "photo_3", title: "photo 3",width: "90px"},
                    {field: "photo_4", title: "photo 4",width: "90px"},
                    {field: "purchase_price", title: "Purchase Price",width: "100px"},
                    {field: "sell_price", title: "Sell Price",width: "90px"},
                    {field: "quantity", title: "Quantity",width: "80px"},
                    {field: "product_code", title: "Product Code",width: "80px"},
                    {field: "manufacturer", title: "Manufacturer",width: "80px"},
