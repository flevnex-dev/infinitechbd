            ...
            <section class="breadcrumbs">
                <div class="container">
                    <ul class="horizontal_list clearfix bc_list f_size_medium">
                        ...
                        <li><a href="#" class="default_t_color"><?php echo $product[0]->brand_name; ?><i class="fa fa-angle-right d_inline_middle m_left_10"></i></a></li>
                    </ul>
                </div>
            </section>
            <!--content-->
                    ...
                    <div class="row clearfix">
                        ...
                        <aside class="col-lg-3 col-md-3 col-sm-3">
                            ...
                            <figure class="widget shadow r_corners wrapper m_bottom_30">
                                ...
                                <div class="widget_content">
                                    <?php 
                                    $best_seller = $obj->FlyQuery("SELECT * FROM product order by id desc limit 4");
                                    ...
                                    <div class="clearfix m_bottom_15 product" style="border-bottom: 1px solid #ededed;">
                                        <img src="cms-admin/upload/<?php echo $best->photo_thumble; ?>" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
                                        <a href="#" class="color_dark d_block bt_link"><?php echo $obj->limit_text(($best->name),6); ?></a>
                                        <!--rating-->
